...
//         <h1 className="home__title">Rafid Islam
//         </h1>
//         <h3 className="home__subtitle">
//             Software Developer
//         </h3>
//         <p className="home__description">
//             I'm a Software Developer based in Dhaka, and I'm very passionate and dedicated to my work.
//         </p>
...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rafid Islam <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                  fill="none"
