...
//     emailjs.sendForm("service_h7jk3fi", "template_bafl8qp", form.current, {
//       publicKey: "ns9u8TM7SqESg0BkM",
//     });
//     e.target.reset();
//   };
...
//       <div className="contact__container app-container app-grid">
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_h7jk3fi", "template_bafl8qp", form.current, {
        publicKey: "ns9u8TM7SqESg0BkM",
      })
      .then(() => {
        setShowSuccess(true);
